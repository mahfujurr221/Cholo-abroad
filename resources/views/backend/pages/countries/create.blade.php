    ...
    <div class="col-xl-10">
        <x-modern.card class="border-0 shadow-sm overflow-hidden">
            <div class="card-header bg-transparent border-0 d-flex justify-content-between align-items-center px-4 pt-4 pb-0">
                <h5 class="fw-bold mb-0">Create New Country</h5>
            ...
            <form action="{{ route('countries.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="card-body p-4">
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            <x-modern.input label="Approval Rate (%)" name="approval_rate" placeholder="e.g. 96%" :value="old('approval_rate')" />
                        </div>
                        <div class="col-md-12">
                        ...
                        <div class="col-md-12">
                            <x-modern.input type="file" label="Flag Icon" name="flag_icon"  />
                        </div>
                        <div class="col-md-12">

            ...
            <form action="{{ route('about-us.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="card-body p-4">
                    <div class="row g-3">
                        ...
                        <div class="col-md-12">
                            <x-modern.input type="textarea" label="Mission" name="mission" placeholder="Enter Mission" :value="old('mission')" rows="6"  />
                        </div>
                        <div class="col-md-12">
                            <x-modern.input type="textarea" label="Mission (Bangla)" name="mission_bn" placeholder="Enter Mission (Bangla)" :value="old('mission_bn')" rows="6"  />
                        </div>
                        <div class="col-md-12">
                            <x-modern.input type="textarea" label="Vision" name="vision" placeholder="Enter Vision" :value="old('vision')" rows="6"  />
                        </div>
                        <div class="col-md-12">
                            <x-modern.input type="textarea" label="Vision (Bangla)" name="vision_bn" placeholder="Enter Vision (Bangla)" :value="old('vision_bn')" rows="6"  />
                        </div>
                        ...
                        <!-- Stats Band -->
                        <div class="col-md-6">
                            <x-modern.input label="Stat 1 Value (e.g. 2019)" name="stat_1_value" placeholder="Enter Stat 1 Value" :value="old('stat_1_value')" />
                        </div>
                        <div class="col-md-6">
                            <x-modern.input label="Stat 1 Label (e.g. Founded in Dhaka)" name="stat_1_label" placeholder="Enter Stat 1 Label" :value="old('stat_1_label')" />
                        </div>
                        <div class="col-md-6">
                            <x-modern.input label="Stat 2 Value" name="stat_2_value" placeholder="Enter Stat 2 Value" :value="old('stat_2_value')" />
                        </div>
                        <div class="col-md-6">
                            <x-modern.input label="Stat 2 Label" name="stat_2_label" placeholder="Enter Stat 2 Label" :value="old('stat_2_label')" />
                        </div>
                        <div class="col-md-6">
                            <x-modern.input label="Stat 3 Value" name="stat_3_value" placeholder="Enter Stat 3 Value" :value="old('stat_3_value')" />
                        </div>
                        <div class="col-md-6">
                            <x-modern.input label="Stat 3 Label" name="stat_3_label" placeholder="Enter Stat 3 Label" :value="old('stat_3_label')" />
                        </div>
                        <div class="col-md-6">
                            <x-modern.input label="Stat 4 Value" name="stat_4_value" placeholder="Enter Stat 4 Value" :value="old('stat_4_value')" />
                        </div>
                        <div class="col-md-6">
                            <x-modern.input label="Stat 4 Label" name="stat_4_label" placeholder="Enter Stat 4 Label" :value="old('stat_4_label')" />
                        </div>
                        <div class="col-md-12">

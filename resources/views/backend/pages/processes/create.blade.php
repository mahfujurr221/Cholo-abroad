    ...
    <div class="col-xl-10">
        <x-modern.card class="border-0 shadow-sm overflow-hidden">
            <div class="card-header bg-transparent border-0 d-flex justify-content-between align-items-center px-4 pt-4 pb-0">
                <h5 class="fw-bold mb-0">Create New Process</h5>
            ...
            <form action="{{ route('processes.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="card-body p-4">
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            <x-modern.input label="Step Number" name="step_number" placeholder="Enter Step Number" :value="old('step_number')" required />
                        </div>
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6 mb-3">
                            <label for="color" class="form-label">Theme Color (Optional)</label>
                            <input type="color" class="form-control form-control-color @error('color') is-invalid @enderror" id="color" name="color" value="{{ old('color', '#00B4DB') }}" title="Choose a color">

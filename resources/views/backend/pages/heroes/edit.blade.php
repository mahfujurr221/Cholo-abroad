            ...
            <form action="{{ route('heroes.update', $hero->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="card-body p-4">
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            <x-modern.input type="textarea" label="Description" name="description" placeholder="Enter description" :value="old('description', $hero->description)" rows="3" />
                        </div>
                        <div class="col-md-6">
                            <x-modern.input type="textarea" label="Description (Bangla)" name="description_bn" placeholder="Enter description in Bangla" :value="old('description_bn', $hero->description_bn)" rows="3" />
                        </div>

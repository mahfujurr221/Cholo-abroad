...
<div class="page-hero">
  ...
  <h1>{!! setting()->contact_title ?? 'Talk to a <span style="color:var(--sky)">counsellor</span> directly' !!}</h1>
  <p>{!! setting()->contact_subtitle ?? 'Visit our Dhaka office, call, or send a message — we reply within one business day.' !!}</p>
</div>
